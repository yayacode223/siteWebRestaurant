    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg w-full max-w-md">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mt-3 sm:mt-4">Connexion</h2>
          <p className="text-sm sm:text-base text-gray-600 mt-1 sm:mt-2">Connectez-vous pour accéder à votre compte</p>
        </div>
